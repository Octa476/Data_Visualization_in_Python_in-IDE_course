...
df2 = pd.read_csv('serious-injury-outcome-indicators-2000-2022.csv')

# TO DO:
# 1) Eliminate all the "Fatal" injuries from the dataset and print the DataFrame to stdout.
# 2) Eliminate all the injuries that aren't recorded during the year 2004 and print DataFrame to stdout.